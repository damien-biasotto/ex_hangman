defmodule LegacyBrowserWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(LegacyBrowserWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(LegacyBrowserWeb.Gettext, "errors", msg, opts)
    # end
