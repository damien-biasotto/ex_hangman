defmodule ModernBrowserWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ModernBrowserWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ModernBrowserWeb.Gettext, "errors", msg, opts)
    # end
